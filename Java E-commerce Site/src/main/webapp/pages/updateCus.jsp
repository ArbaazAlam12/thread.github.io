...
<% 
	...
	// Deleting item on database when delete button is clicked.
	 ...
	 if(request.getParameter("updateId") != null){
	    ...
	    dbConn.deleteUser(MyConstants.UPDATE_USER_INFO, id);
	}
%>
<!DOCTYPE html>
<html>
...
.h2s{
  ...
  <sql:setDataSource var="dbConnection" driver="com.mysql.jdbc.Driver"
    ...
    <div class="containerd">
      ...
      <form action="${pageContext.request.contextPath}/updateCustomer" method="post" ENCTYPE="multipart/form-data"> 
      <div class="form">
         ...
         <!--Using form tag a form is created, the form input are kept inside a div and it will be submitted after filling, and there is also option if user is already signed in then they can sign in-->
          ...
          <c:forEach var="user" items="${allUser.rows}">
            <div style=" margin-left: 20px;">
              ...
              <input class="box" type="text" name="num1" size=24 value="${user.contact_number}" required><br><br>
              <label class="text">Password</label><br>
              
              <input class="box" type="password" name="password" size=24 placeholder="Please enter aleast 6 charaters"  value="${user.password}"><br>
              <label class="text" >Role</label><br>
              <input class="box" type="text" name="role" size=24 value="${user.contact_number}" required><br><br>
